...
using Serilog;
using SimformMicroservice_Project1.Api.Middleware;
...
using SimformMicroservice_Project1.Repository.Repository;
using SimformMicroservice_Project1.Repository;
using SimformMicroservice_Project1.Service.IService;
using SimformMicroservice_Project1.Service.Service;
using SimformMicroservice_Project1.Service.Validators;
...
builder.Services.AddAutoMapper(typeof(SimformMicroservice_Project1.Service.Mapper.MappingProfile));
